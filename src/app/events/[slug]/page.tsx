...
export default function Event() {
  return (
    <>
      <div className="min-h-screen flex flex-col sm:flex-row items-center md:items-start">
        <div className="w-3/4 md:w-1/4 h-1/2 m-2 mb-5 md:m-5 p-10 rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <Image
        ...
        <div className="w-3/4 flex flex-col md:my-5 md:mr-5 p-10 rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <h1 className="mb-5 text-2xl font-bold text-black dark:text-white">
            Tanya Ustadz
          </h1>
          <div className="w-full flex justify-center">
            <input
              className="w-1/2 p-5 rounded-lg border focus:border-2  focus:border-primary focus:outline-none bg-transparent"
              type="text"
              placeholder="Tulis Pertanyaan ..."
            />
            <button className="ml-4 w-20 btn bg-primary text-white p-2 rounded-md ">
              Kirim
            </button>
          </div>
        </div>
