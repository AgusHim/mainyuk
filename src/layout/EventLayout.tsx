              ...
              <div className="grid space-y-2">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col overflow-hidden rounded-xl border border-black bg-yellow-200">
                      ...
                      <div className="flex items-center justify-between gap-4 rounded-b-xl border-t-2 border-dashed border-black  px-4 py-3">
                        ...
                        {false ? (
                          ...
                          <div className="flex items-center gap-x-1">
                            <button className="rounded-lg text-black border-2 border-black bg-yellow-300 p-2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                            ...
                            <input
                              ...
                              name="qty-cm0i2q7m4000fmk03b2hszv5o"
                              type="text"
                              value="1"
                            />
                            <button className="rounded-lg text-black border-2 border-black bg-yellow-300 p-2">
