          ...
          <tbody>
            {orders?.map((data, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-black py-5 px-4">
                  <p className="text-black dark:text-white">{data.amount == 0?'GRATIS':`Rp ${data.amount.toLocaleString("id-ID")}`}</p>
                </td>
                <td className="border-b border-black py-3 px-2">
                  <p className="text-black dark:text-white">
                    {formatStrToDateTime(data.expired_at!, "dd-MM-yyyy HH:mm")}
                  </p>
                </td>
                <td className="border-b border-black py-3 px-2">
                  <p className="text-black dark:text-white">
                    {formatStrToDateTime(data.created_at!, "dd-MM-yyyy HH:mm")}
                  </p>
                </td>
                <td className="border-b border-black py-3 px-2">
                  <p className="text-black dark:text-white">
                    {formatStrToDateTime(data.updated_at!, "dd-MM-yyyy HH:mm")}
                  </p>
                </td>
                <td className="border-b border-black py-5 px-4">
